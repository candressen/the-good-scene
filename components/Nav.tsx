  ...
  return (
    <>
      ...
      <header className='fixed left-1/2 top-6 z-50 hidden w-[calc(100%-48px)] -translate-x-1/2 lg:block'>
        <div className='mx-auto flex h-[88px] max-w-[1240px] items-center justify-between rounded-[18px] bg-white px-8 shadow-sm'>
          <div className='flex items-center min-w-[220px]'>
            <Link href='/'><Image src='/logos/logo.svg' alt='The Good Scene' width={160} height={46} className='h-[64px] w-auto object-contain scale-[1.35] origin-left' priority /></Link>
          </div>
      ...
      <header className='fixed top-4 left-4 right-4 z-50 flex h-[64px] items-center justify-between rounded-[16px] bg-white px-5 shadow-sm lg:hidden'>
        <Link href='/'><Image src='/logos/logo.svg' alt='The Good Scene' width={120} height={38} className='h-[44px] w-auto object-contain' priority /></Link>
